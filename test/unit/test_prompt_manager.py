...
from src.services.language_detection.bilingual_prompt_manager import BilingualPromptManager, PromptConfig
...
class TestBilingualPromptManager:
    ...
    def test_english_prompt_selection(self, prompt_manager):
        ...
        with (
            ...
            patch.object(prompt_manager, '_prompt_cache', {"v1.4.0-en": Mock()}),


            patch.object(prompt_manager, 'get_latest_version', return_value="v1.4.0")
    ...
    def test_traditional_chinese_prompt_selection(self, prompt_manager):
        ...
        with (
            ...
            patch.object(prompt_manager, '_prompt_cache', {"v1.4.0-zh-TW": Mock()}),
    ...
    def test_version_not_available_fallback(self, prompt_manager, mock_prompt_data):
        ...
        with (
            patch.object(prompt_manager, 'get_available_versions', return_value=["v1.4.0"]),
            pytest.raises(PromptNotAvailableError) as exc_info
        ):
