...
def main():
    ...
    log_files = [
        ('Unit Tests - Health Check', '/tmp/unit_health_output.log'),
        ('Unit Tests - Keyword Extraction', '/tmp/unit_keyword_extraction_output.log'),
        ('Unit Tests - Keyword Extraction Extended', '/tmp/unit_keyword_extended_output.log'),
        ('Unit Tests - Language Detection', '/tmp/unit_language_detection_output.log'),
        ('Unit Tests - Prompt Manager', '/tmp/unit_prompt_manager_output.log'),
        ('Integration Tests - Keyword Language', '/tmp/integration_keyword_language_output.log'),
        ('Integration Tests - Health Check', '/tmp/integration_health_output.log'),
        ('Integration Tests - Azure OpenAI', '/tmp/integration_azure_openai_output.log'),
        ('Performance Tests - Keyword Extraction', '/tmp/performance_keyword_output.log')
    ]
